...
public class SenderPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sendMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/sent.png"))); // NOI18N
        ...
        addFriendMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/friend.png"))); // NOI18N
        ...
        themeMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/theme.png"))); // NOI18N
        ...
        homeMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/home.png"))); // NOI18N
        ...
        sendingPanel.setBackground(new java.awt.Color(255, 234, 233));
        sendingPanel.setPreferredSize(new java.awt.Dimension(800, 600));
        sendingPanel.setRequestFocusEnabled(false);
        sendingPanel.setLayout(null);

        messagePanel.setBackground(new java.awt.Color(242, 193, 193));
        messagePanel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(229, 185, 185), 2));

        sendMessBtn.setBackground(new java.awt.Color(193, 187, 234));
        sendMessBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/sent-minus.png"))); // NOI18N

        messageField.setText("Text here...");
        messageField.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        messagePanelLayout.setHorizontalGroup(
            ...
            .addGroup(messagePanelLayout.createSequentialGroup()
                .addGap(31, 31, 31)
                .addComponent(messageField, javax.swing.GroupLayout.DEFAULT_SIZE, 466, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(sendMessBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
        );
        messagePanelLayout.setVerticalGroup(
            ...
            .addGroup(messagePanelLayout.createSequentialGroup()
                ...
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(sendMessBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(16, Short.MAX_VALUE))
        );

        sendingPanel.add(messagePanel);
        messagePanel.setBounds(210, 470, 590, 80);

        leftPanel1.setBackground(new java.awt.Color(250, 207, 207));
        leftPanel1.setLayout(new java.awt.BorderLayout());

        friendList.setBackground(new java.awt.Color(250, 215, 215));
        friendList.setBorder(null);
        friendList.setFont(new java.awt.Font("Microsoft JhengHei Light", 0, 14)); // NOI18N
        friendList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 4", "Item 5", "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        friendList.setSelectionBackground(new java.awt.Color(255, 168, 168));
        leftPanel1.add(friendList, java.awt.BorderLayout.CENTER);

        topLeftPanel1.setBackground(new java.awt.Color(250, 194, 194));

        friendListLbl.setFont(new java.awt.Font("Nirmala UI", 1, 16)); // NOI18N
        friendListLbl.setForeground(new java.awt.Color(226, 90, 90));
        friendListLbl.setText("Friend                    ");
        topLeftPanel1.add(friendListLbl);

        delFriendBtn.setBackground(new java.awt.Color(255, 102, 102));
        delFriendBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/bin.png"))); // NOI18N
        delFriendBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                delFriendBtnActionPerformed(evt);
            }
        });
        topLeftPanel1.add(delFriendBtn);

        leftPanel1.add(topLeftPanel1, java.awt.BorderLayout.NORTH);

        sendingPanel.add(leftPanel1);
        leftPanel1.setBounds(0, 0, 210, 550);

        errorSendingLbl.setFont(new java.awt.Font("Bahnschrift", 0, 12)); // NOI18N
        errorSendingLbl.setForeground(new java.awt.Color(255, 102, 0));
        errorSendingLbl.setText("Error");
        sendingPanel.add(errorSendingLbl);
        errorSendingLbl.setBounds(220, 450, 466, 15);

        mainFrame.add(sendingPanel);
        sendingPanel.setBounds(0, 50, 800, 550);
        ...
        addFriendBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/plus.png"))); // NOI18N
        ...
        acceptFriendBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/plus-minus.png"))); // NOI18N
