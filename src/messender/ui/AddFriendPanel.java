...
public class AddFriendPanel extends JPanel implements ActionListener 
{
	...
	private JButton delFriendRequestBtn;
	...
	public AddFriendPanel(Session s)
	{
		...
		delFriendRequestBtn = new JButton("X");
		delFriendRequestBtn.setFocusPainted(false);
		delFriendRequestBtn.setBackground(new Color(255, 102, 102));

		topLeftPanel.add(friendRequestListLbl);
		topLeftPanel.add(delFriendRequestBtn);
		...
		// adding listeners
		delFriendRequestBtn.addActionListener(this);
		addFriendBtn.addActionListener(this);
	}

	public void clearError() 
	{
		this.errorAddFriendLbl.setText("");
	}
