...
import messender.uiTest.Loading;
...
public class SendingPanel extends JPanel implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		if ( friendList.getSelectedValue() == null )
			errorSendingLbl.setText("Select a conversation first. Don't have any friend ? Add one ! ");      

		boolean sending = e.getSource() == sendMessBtn || e.getSource() == messageField; 
		if ( sending && friendList.getSelectedValue() != null )
		{
		...
		{
			int delFriend = JOptionPane.showInternalConfirmDialog(
				this,
				"Do you want to delete " + friendList.getSelectedValue(), // message
		"Are you sure", // title
